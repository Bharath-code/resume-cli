 ...
 * Add to favorites
 */
export function addToFavorites(section: SectionKey): UserConfig {
 ...
 */
export function removeFromFavorites(section: SectionKey): UserConfig {
  const config = loadConfig();
 ...
 */
export function addToSearchHistory(query: string): UserConfig {
  const config = loadConfig();
 ...
 */
export function getThemeColors(config: UserConfig): ThemeColors {
