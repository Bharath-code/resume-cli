...
export type Industry = 'technology' | 'finance' | 'healthcare' | 'education' | 'creative' | 'consulting' | 'marketing' | 'engineering' | 'sales' | 'legal' | 'nonprofit' | 'startup' | 'corporate' | 'freelance';
