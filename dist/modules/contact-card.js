...
export class ContactCardExporter {
     ...
     */
    static async exportCard(resumeData, options) {
     ...
     */
    static async saveCard(resumeData, outputPath, options) {
     ...
     */
    static async createBusinessCard(resumeData, options) {
     ...
     */
    static async generateQRCodes(resumeData, qrType) {
        const qrCodes = {};
     ...
     */
    static generateVCard(businessCard) {
        const vcard = [
            'BEGIN:VCARD',
            'VERSION:3.0',
     ...
     */
    static generateJSON(businessCard) {
        return JSON.stringify(businessCard, null, 2);
    }
    /**
     * Generate HTML format
     */
    static generateHTML(businessCard, options) {
...
<body>
     ...
     */
    static generatePDF(businessCard, options) {
...
${htmlContent}`;
     ...
     */
    static async generateAll(businessCard, options) {
        return {
     ...
     */
    static generateQRCodeHTML(qrCodes) {
...
ContactCardExporter.VERSION = '1.0.0';
