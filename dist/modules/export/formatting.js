 ...
 */
export function formatColoredResume(data, sections) {
 ...
 */
export function formatPlainResume(data, sections) {
    const selectedSections = sections || ['personal', 'profile', 'techStack', 'experience', 'projects', 'leadership', 'openSource', 'education'];
    let output = '';
    if (selectedSections.includes('personal')) {
 ...
 */
export function formatJsonResume(data, sections) {
    const selectedSections = sections || ['personal', 'profile', 'techStack', 'experience', 'projects', 'leadership', 'openSource', 'education'];
    const filteredData = {};
...
export async function formatPdfResume(data, sections) {
