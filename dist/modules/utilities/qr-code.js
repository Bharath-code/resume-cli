...
export class QRCodeGenerator {
     ...
     */
    static async generateVCard(contactInfo, options = {}) {
        const vCardData = this.createVCardData(contactInfo);
        const qrOptions = { ...this.defaultOptions, ...options, type: 'vcard' };
        return this.generateQRCode(vCardData, qrOptions);
    }
    /**
     * Generate QR code for LinkedIn profile
     */
    static async generateLinkedIn(linkedinUrl, options = {}) {
        const qrOptions = { ...this.defaultOptions, ...options, type: 'linkedin' };
        return this.generateQRCode(linkedinUrl, qrOptions);
    }
    /**
     * Generate QR code for portfolio/website
     */
    static async generatePortfolio(portfolioUrl, options = {}) {
        const qrOptions = { ...this.defaultOptions, ...options, type: 'portfolio' };
        return this.generateQRCode(portfolioUrl, qrOptions);
    }
    /**
     * Generate QR code for GitHub profile
     */
    static async generateGitHub(githubUrl, options = {}) {
        const qrOptions = { ...this.defaultOptions, ...options, type: 'github' };
        return this.generateQRCode(githubUrl, qrOptions);
    }
    /**
     * Generate QR code for email
     */
    static async generateEmail(email, subject, body, options = {}) {
        ...
        const qrOptions = { ...this.defaultOptions, ...options, type: 'email' };
        return this.generateQRCode(emailData, qrOptions);
    }
    /**
     * Generate QR code for phone number
     */
    static async generatePhone(phoneNumber, options = {}) {
        const phoneData = `tel:${phoneNumber.replace(/[^+\d]/g, '')}`;
        const qrOptions = { ...this.defaultOptions, ...options, type: 'phone' };
        return this.generateQRCode(phoneData, qrOptions);
    }
    /**
     * Generate multiple QR codes from resume data
     */
    static async generateFromResumeData(resumeData, types, options = {}) {
        const results = {};
     ...
     */
    static async saveQRCode(qrCodeData, filePath, format = 'png') {
     ...
     */
    static async generateBatch(resumeData, outputDir, options = {}) {
        const types = ['vcard', 'linkedin', 'portfolio', 'github', 'email', 'phone'];
     ...
     */
    static createVCardData(contactInfo) {
        const vcard = [
            'BEGIN:VCARD',
            'VERSION:3.0',
     ...
     */
    static extractContactInfo(resumeData) {
...
QRCodeGenerator.defaultOptions = {
    type: 'vcard',
    format: 'png',
    size: 200,
